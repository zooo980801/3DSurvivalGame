...
| 이름 | 역할 | 담당 내용 |
|------|------|-----------|
| 주영훈 | 팀장 | UI/UX (인벤토리) ,플레이어/상태 UI|
| 장세희 | 팀원 | 게임 시스템 총괄,|
| 조경현 | 팀원 | 씬 전환, Timeline, 사운드, 엔딩 처리 및 통합 ,알림UI, Title화면, 저장/불러오기  |
| 김건형 | 팀원 | 자원 수집, 건축 시스템, 맵 오브젝트 |
| 박나연 | 팀원 | 선비 상태, 대화, 이벤트, 배회 AI |
| 손양복 | 팀원 | 외부 위협 적 AI (도둑, 산적, 호랑이 등) |
